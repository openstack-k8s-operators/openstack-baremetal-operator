...
ARG IMAGE_COMPONENT="openstack-baremetal-operator-container"
ARG IMAGE_NAME="openstack-baremetal-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="OpenStack Baremetal Operator"
ARG IMAGE_DESC="This image includes the openstack-baremetal-operator"
